		...
		<div class="container">
			<div class="content-page">
				<div class="shop-banner banner-adv line-scale zoom-image">
					...
					<div class="banner-info">
						<h2 class="title30 color">Sobre nós</h2>
						<div class="bread-crumb white"><a href="<?php echo base_url();?>" class="white">Início</a><span>Sobre nós</span></div>
					</div>
				</div>				<!-- ENd Banner -->
			...
			<div class="col-md-12">
				<div class="title-cart">						
					<h3 class="texto-titulo">Quem somos?</h3>
				</div>
				<p class="col texto text-justify">
					A Belém Frutas tem como propósito levar saúde e bem-estar para o seu cotidiano, por meio da entrega de frutas, verduras e legumes, produtos selecionados, higienizados e prontos para serem utilizados em seus respectivos fins. Queremos que as pessoas sejam mais felizes em aproveitar nossa variedade de produtos com ofertas imperdíveis, e acreditamos que o estímulo que temos é ver nossos clientes sempre satisfeitos com a nossa prestação de serviços.
				</p>
				<hr>
			</div>
