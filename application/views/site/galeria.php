						...
						<div class="col-md-12">
							<nav class="main-nav main-nav2 pull-left">
								<ul>
									...
									<li class="current-menu-item menu-item-has-children"><a href="<?php echo base_url('galeria') ?>">GALERIA</a></li>
			...
			<div class="container">
				<div class="row">
						...
						<div class="banner-slider banner-slider5">
							<div class="wrap-item" data-pagination="false"  data-autoplay="true" data-navigation="true" data-itemscustom="[[0,1]]">
								<div class="item-slider item-slider5">
									<div class="banner-thumb"><a href="#"><img src="<?php echo base_url('assets/site/images/home/home5/slide1.jpg')?>" alt="" /></a></div>
									<div class="banner-info text-center">
										<h3 class="title30 paci-font">Produtos em até</h3>
										<h2 class="title60 color text-uppercase font-bold">45% Off</h2>
									</div>
								</div>
								<div class="item-slider item-slider5">
									<div class="banner-thumb"><a href="#"><img src="<?php echo base_url('assets/site/images/home/home5/slide2.jpg')?>" alt="" /></a></div>
									<div class="banner-info text-center">
										<h3 class="title30 paci-font">Delivery de Frutas</h3>
										<h2 class="title60 color text-uppercase font-bold">45% Off</h2>
									</div>
								</div>
								<div class="item-slider item-slider5">
									<div class="banner-thumb"><a href="#"><img src="<?php echo base_url('assets/site/images/home/home5/slide3.jpg')?>" alt="" /></a></div>
									<div class="banner-info text-center">
										<h3 class="title30 paci-font">Mega Saldão de Estoque</h3>
										<h2 class="title60 color text-uppercase font-bold"> 45% off</h2>
									</div>
								</div>
							</div>
					...
					<div class="col-md-3 col-sm-6 col-xs-6">
						<div class="list-adv-left5">
							<div class="banner-adv item-adv5 overlay-image zoom-rotate">
								<a href="#" class="adv-thumb-link"><img src="<?php echo base_url('assets/site/images/home/home5/ad1.jpg')?>" alt="" /></a>
								<div class="banner-info white text-center">
									<h3 class="title18"><a href="#" class="white">Legumes </a></h3>									
								</div>
							</div>
							<div class="banner-adv item-adv5 overlay-image zoom-rotate">
								<a href="#" class="adv-thumb-link"><img src="<?php echo base_url('assets/site/images/home/home5/pop4.jpg')?>" alt="" /></a>
								<div class="banner-info white text-center">
									<h3 class="title18"><a href="#" class="white">Caju</a></h3>				
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-6">
						<div class="list-adv-right5">
							<div class="banner-adv item-adv5 overlay-image zoom-rotate">
								<a href="#" class="adv-thumb-link"><img src="<?php echo base_url('assets/site/images/home/home5/ad2.jpg')?>" alt="" /></a>
								<div class="banner-info white text-center">
									<h3 class="title18"><a href="#" class="white"> Cestas de Produtos</a></h3>				
								</div>
							</div>
							<div class="banner-adv item-adv5 overlay-image zoom-rotate">
								<a href="#" class="adv-thumb-link"><img src="<?php echo base_url('assets/site/images/home/home5/ad4.jpg')?>" alt="" /></a>
								<div class="banner-info white text-center">
									<h3 class="title18"><a href="#" class="white">Morangos Especiais</a></h3>			
								</div>
							</div>
						</div>
					</div>
