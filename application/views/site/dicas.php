						...
						<div class="col-md-12">
							<nav class="main-nav main-nav2 pull-left">
								<ul>
									...
									<li class="current-menu-item menu-item-has-children"><a href="<?php echo base_url('dicas') ?>">DICAS</a></li>
									<li>
			...
			<div class="content-page">
				<div class="shop-banner banner-adv line-scale zoom-image">
					...
					<div class="banner-info">
						<h2 class="title30 color">Dicas</h2>
						<div class="bread-crumb white"><a href="<?php echo base_url();?>" class="white">Início</a><span>Dicas</span></div>
					</div>
				</div>				<!-- ENd Banner -->
